...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2933.4072050482387; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -3130.9537758530073; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2935.0357905919177; // x position of the perpendicular encoder (in tick units)
    }
